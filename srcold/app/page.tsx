      ...
      reader.onload = async (e) => {
        ...
        Papa.parse<RouteData>(csv, {
          ...
          complete: async (results) => {
            ...
            // Log the waypoint array for debugging
            console.log("Waypoints:", waypointArray);
            ...
            console.log("Distance Matrix Data:", distanceMatrixData); // Log for debugging
            ...
            for (let i = 0; i < waypointArray.length - 1; i++) {
              ...
              distanceMatrixData.rows[last].elements.forEach(
                (element: any, index: number) => {
                  if (
                    !visited[index] &&
                    element.duration_in_traffic.value < nearestTime
                  ) {
                    nearest = index;
            ...
            const optimizedRoute = tspRoute.map(
              (index) => waypointArray[index]
            );
